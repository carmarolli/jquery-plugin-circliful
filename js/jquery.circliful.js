(function ($) {
    ...
    $.fn.circliful = function (options) {
        ...
        return this.each(function () {
            ...
            function drawEndingCircle(x, y, settings) {
                context.beginPath();
                context.arc(x, y, settings.width, 0, 2 * Math.PI);
            ...
            function animate(current) {
                ...
                // Draw little circle on the arc
                var xpos = x + Math.cos(((circ) * current) - quart) * radius;
                var ypos = y + Math.sin(((circ) * current) - quart) * radius;
                if (settings.endingCircle) {
                    drawEndingCircle(xpos, ypos, settings.endingCircle);
                }
